 ...
 *	Los objetos de este tipo de utilizan en el análisis de más bajo nivel. Crean una estructura de datos donde se van 
 *       recogiendo los estados de cuantificación de las variables. (vg. X está cuantificada existencialmente y negado, T no está
...
class capturadorCuantificadores{
	...
	public void negar(char variable){	//cambia (1 -> 0) o (0 -> 1) el valor de negación de un cuantificador
		switch (variable){
			case 'x':{
	...
	public boolean negado(char variable){		//¿Está negado el cuantificador de cierta variable?
