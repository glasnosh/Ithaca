/*
 *  "hilo_seleccionar_subarbol_master.java"
 * 	
 *	Hilo que selecciona una derivación del árbol para la máquina cuando esta juega siguiendo estrategias
 *
...
/*
 *	public hilo_seleccionar_subarbol_master(
...
public class hilo_seleccionar_subarbol_master extends Thread {
	...
	public void run(){
		int subarbol  = seguidor._obtener_salida();
