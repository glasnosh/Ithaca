 ...
 *	Evaluador de fórmulas simples en una estructura de la malla similar a un cilindro. (en la version final no se usa)
 *
...
public class analizadorFunciones_CILINDRO_{
	...
	public int analizar_IZQUIERDA (int x1, int y1, int x2, int y2) { // En la práctica es que están en distinta columna
		int result = 100;
		if ( (mimalla.devolverCasilla(x1,y1).ocupada) && (mimalla.devolverCasilla(x2,y2).ocupada) ){
			if (y1 != y2) result = 1;
			else result = 0;
	...
	public int analizar_DERECHA (int x1, int y1, int x2, int y2) { // En la práctica es que están en distinta columna
		int result = 100;
		if ( (mimalla.devolverCasilla(x1,y1).ocupada) && (mimalla.devolverCasilla(x2,y2).ocupada) ){
			if (y1 != y2) result = 1;
			else result = 0;
