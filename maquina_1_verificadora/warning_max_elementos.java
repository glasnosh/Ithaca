 ...
 *	Clase que hereda de JDialog para mostrar un aviso si se trata de introducir más de 15 elementos en la malla.
 * 
 *
...
class warning_max_elementos extends JDialog{
	...
	JLabel etiquetatexto = new JLabel("No se pueden insertar más de 15 elementos");
